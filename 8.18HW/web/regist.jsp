            ...
            <form action="regist.do" method="post">
                <table border="0" style="width:420px; font-size:14px; margin-top:20px;" cellspacing="0" cellpadding="0">
                    ...
                    <tr height="50">
                        ...
                        <td><input name="loginName" type="text" value="" class="l_user" id="userName"/></td>
                    </tr>
                    <tr>
                        <td colspan="2" id="nameErr" style="color: red">

                        </td>
                    </tr>
                    <tr height="50">
                        <td align="right"><font color="#ff4e00">*</font>&nbsp;密码 &nbsp;</td>
                        <td><input name="password" type="password" value="" class="l_pwd" id="pwd"/></td>
                    </tr>
                    <tr>
                        <td colspan="2" id="pwdErr" style="color: red">
                        </td>
                    </tr>
                    <tr height="50">
                        <td align="right"><font color="#ff4e00">*</font>&nbsp;确认密码 &nbsp;</td>
                        <td><input name="checkPwd" type="password" value="" class="l_pwd" id="confirmPwd"/></td>
                    </tr>
                    <tr>
                        <td colspan="2" id="confirmPwdErr" style="color: red">
                        </td>
                    </tr>
                    <tr height="50">
                        <td align="right"><font color="#ff4e00">*</font>&nbsp;邮箱 &nbsp;</td>
                        <td><input name="email" type="text" value="" class="l_email" id="email"/></td>
                    </tr>
                    <tr>
                        <td colspan="2" id="emailErr" style="color: red">
                        </td>
                    </tr>
                    <tr height="50">
                        <td align="right"><font color="#ff4e00">*</font>&nbsp;手机 &nbsp;</td>
                        <td><input name="mobile" type="text" value="" class="l_tel" id="phone"/></td>
                    </tr>
                    <tr>
                        <td colspan="2" id="phoneErr" style="color: red">
                        </td>
                    </tr>
                    <tr height="50">
...
<script>
    $(function () {
        $(".log_btn").click(function () {
            ...
            if (confirmPwd.trim() == "") {
                $("#confirmPwdErr").innerHTML("确认密码不能为空");
                check = true;
            }
            if (email.trim() == "") {
